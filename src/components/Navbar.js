  ...
  render() {
    return (
      <nav className={`Navbar ${this.state.mobileIsOpen ? "Navbar--mobile-is-open" : ""}`}>
        ...
        <button className="Navbar__close u-btn-clear a-fade-in" onClick={this.handleToggleMobileNav}>Close</button>
      </nav>
    )
  }
}